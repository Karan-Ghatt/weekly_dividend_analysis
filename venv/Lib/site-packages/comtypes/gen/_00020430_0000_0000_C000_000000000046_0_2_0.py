...
IFontDisp = Font
__all__ = [ 'Checked', 'OLE_XSIZE_HIMETRIC', 'Unchecked', 'Picture',
           'OLE_OPTEXCLUSIVE', 'OLE_XPOS_CONTAINER',
           'OLE_YPOS_CONTAINER', 'IPicture', 'OLE_CANCELBOOL',
           'StdPicture', 'IPictureDisp', 'OLE_XPOS_HIMETRIC',
           'OLE_TRISTATE', 'FONTITALIC', 'FONTNAME', 'IFontDisp',
           'OLE_HANDLE', 'Gray', 'OLE_XSIZE_PIXELS', 'IFont',
           'OLE_YPOS_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL', 'VgaColor',
           'Color', 'FONTUNDERSCORE', 'OLE_YSIZE_PIXELS', 'Default',
           'FONTSTRIKETHROUGH', 'OLE_XSIZE_CONTAINER', 'FONTSIZE',
           'OLE_XPOS_PIXELS', 'OLE_YSIZE_CONTAINER', 'StdFont',
           'OLE_YPOS_PIXELS', 'IFontEventsDisp', 'FontEvents',
           'FONTBOLD', 'LoadPictureConstants', 'Monochrome', 'Font',
